export const handleRezultat = (
  ...
  setRezultat((prevState) => ({
    ...
    caen_rezultat: Object.keys(caenuri).filter((key) => caenuri[key] === true),
  }));
...
export const handleSearchSectiune = (sectiune, setSearchSectiune) => {
...
export const handleDiviziune = (diviziune, setDiviziuni) => {
...
export const handleGrupa = (grupa, setGrupe) => {
  setGrupe((prevState) => ({
    ...prevState,
...
export const handleCaen = (caen, setCaenuri) => {
...
export const handleDepartment = (department, setDepartments) => {
  setDepartments((prevState) => ({
    ...prevState,
    [department]: {
      ...prevState[department],
      state: !prevState[department].state,
    },
  }));
};

export const handleJob = (department, job, setDepartments) => {
  setDepartments((prevState) => ({
    ...prevState,
    [department]: {
      ...prevState[department],
      job_titles: {
        ...prevState[department].job_titles,
        [job]: !prevState[department].job_titles[job],
      },
    },
  }));
};

export const handleToggleAllSectiuni = (value, setSearchSectiune) => {
  setSearchSectiune((prevState) => {
    const newState = {};
...
export const handleToggleAllDiviziuni = (
  value,
  setDiviziuni,
  filteredDiviziuni
) => {
...
export const handleToggleAllGrupe = (value, setGrupe, filteredGrupe) => {
  setGrupe((prevState) => {
    const newState = { ...prevState };
...
export const handleToggleAllCaenuri = (value, setCaenuri, filteredCaen) => {
  setCaenuri((prevState) => {
    const newState = { ...prevState };
...
export const handleToggleAllDepartments = (value, setDepartments) => {
  setDepartments((prevState) => {
    const newState = {};
    Object.keys(prevState).forEach((department) => {
      newState[department] = {
        ...prevState[department],
        state: value,
      };
...
export const handleToggleAllJobs = (value, setDepartments) => {
  setDepartments((prevState) => {
    const newState = {};
    Object.keys(prevState).forEach((department) => {
      newState[department] = {
        ...prevState[department],
        job_titles: Object.keys(prevState[department].job_titles).reduce(
          (acc, job) => {
            acc[job] = value;
            return acc;
          },
...
export const handlePortie = (selectedPortie, setPortie, setRezultatAfis) => {
  setPortie((prevState) => {
...
const handleToggleAllFalse = (setDepartments) => {
  setDepartments((prevState) => {
    const newState = {};
    Object.keys(prevState).forEach((department) => {
      newState[department] = {
...
export const handleResetAll = (
  ...
  setRezultatAfis(false);
  handleToggleAllFalse(setDepartments);
};
